...
import com.tangokk.redisretry.lib.exception.JsonDeserializeException;
...
public interface RedisSerializer<T> {
	 ...
	 */
	byte[] serialize(T t) throws JsonSerializeException;
	 ...
	 */
	T deserialize(byte[] bytes) throws JsonDeserializeException;
}
